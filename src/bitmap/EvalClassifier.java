...
public class EvalClassifier {
	...
	private Vector<ClassifiedBitmap> bitmaps = null;
	public int numRight = 0;
	public int numWrong = 0;

	public EvalClassifier(Classifier c, Vector<ClassifiedBitmap> bitmaps) {
		this.c = c;
	...
	public void run() {
		...
		double accuracy = numRight / (double)bitmaps.size();
